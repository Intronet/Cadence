...
export const sampler = new Tone.Sampler({
  urls: {
    ...
    D1      : 'D1.mp3'  ,     D2     : 'D2.mp3'    ,   D3    :   'D3.mp3'  ,   D4    : 'D4.mp3'   ,   D5    : 'A5.mp3'    ,   D6    :   'D6.mp3'    , D7    : 'D7.mp3',
  ...
  release: 0.1,
  baseUrl: "https://intronet.github.io/Samples/Instruments/piano/"
}).toDestination();
...
export const bassSampler = new Tone.Sampler({
  ...
  release: 0.2,
  baseUrl: "https://intronet.github.io/Samples/Instruments/bass-electric/"
});
