...
export const OctaveSlider: React.FC<OctaveSliderProps> = ({ octave, setOctave }) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-3 bg-gray-800 border-2 border-gray-700 rounded-[4px] p-1 pr-3 h-[2.625rem]">
        <input
          type="range"
          min="-3"
          max="3"
        ...
        />
        <span 
          className="text-sm font-medium text-gray-200 w-8 text-center flex-shrink-0" 
          title={`Octave: ${octaveLabel}`}
        >
          {octaveLabel}
        </span>
      </div>
