  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <textarea
        ...
        className="bg-gray-800 border-2 border-gray-700 text-gray-200 text-sm rounded-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent block w-full p-2.5 transition-all duration-200 resize-none h-20 disabled:opacity-50"
